define(['tslib', '@docsvision/webclient/System/$MessageBox', '@docsvision/webclient/System/DateTimeUtils', '@docsvision/webclient/System/ExtensionManager'], (function (tslib, $MessageBox, DateTimeUtils, ExtensionManager) { 'use strict';
    ...
    var BusinessTripRegistrationLogic = /** @class */ (function (_super) {
        ...
        BusinessTripRegistrationLogic.prototype.showCardSummary = function (layout) {
            ...
            return tslib.__awaiter(this, void 0, void 0, function () {
                var messageBox, APPLICATION_NAME_CTRL, DATE_FROM_CTRL, DATE_TO_CTRL, TRIP_BASIS_TEXT_CTRL, CREATED_DATE_CTRL, TRIP_CITY_CTRL, nameCtrl, cardTitle, createdCtrl, createdRaw, createdAt, cityCtrl, cityText, cityValue, fromCtrl, toCtrl, fromRaw, toRaw, fromDate, toDate, basis, basisTextCtrl, basisRaw, basisPlain, lines;
                return tslib.__generator(this, function (_g) {
                    switch (_g.label) {
                        case 0:
                            ...
                            cityText = null;
                            if (cityCtrl) {
                                cityValue = (_c = cityCtrl.getParamValue) === null || _c === void 0 ? void 0 : _c.call(cityCtrl, "value");
                                if (cityValue) {
                            ...
                            fromRaw = (_d = fromCtrl.getParamValue) === null || _d === void 0 ? void 0 : _d.call(fromCtrl, "value");
                            toRaw = (_e = toCtrl.getParamValue) === null || _e === void 0 ? void 0 : _e.call(toCtrl, "value");
                            fromDate = this.parseDate(fromRaw);
                            toDate = this.parseDate(toRaw);
                            basis = null;
                            basisTextCtrl = layout.controls.tryGet(TRIP_BASIS_TEXT_CTRL);
                            if (basisTextCtrl) {
                                basisRaw = (_f = basisTextCtrl.getParamValue) === null || _f === void 0 ? void 0 : _f.call(basisTextCtrl, "value");
